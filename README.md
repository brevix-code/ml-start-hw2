...
<br>Выбрал этот датасет, потому что по сравнению с другими вариантами он имеет небольшой размер и понятные признаки. При этом датасет не такой простой и есть пространство для проверки нескольких моделей и ансамблей.
